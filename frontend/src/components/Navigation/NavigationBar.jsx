...
const NavigationBar = ({ handleTheme, theme }) => {
  ...
  const navbarClassName =
    theme === "Dark" ? "custom-navbar dark-theme" : "custom-navbar";
  return (
          ...
          <Nav className="auth-buttons">
            ...
            {isAuthenticated && (
              <>
                <NavDropdown
                  ...
                  title={
                    <div className="d-flex">
                      {`${user?.nickname[0].toUpperCase()}${user?.nickname.slice(
                        1
                      )}`}
                      <img
                        src={user?.picture}
                ...
                >
                  <NavDropdown.Item as={Link} to="/myMessages">
                    Chats
                  </NavDropdown.Item>
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item className="d-flex" style={{}}>
                    <img
                      src={user?.picture}
                      alt="profile picture"
                      style={{
